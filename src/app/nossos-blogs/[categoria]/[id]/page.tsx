    ...
    return (
        <main>
            <section className="max-w-360 mx-auto p-8 lg:px-16">
                <Link href={`/nossos-blogs/${categoria}`} className="block mb-8 text-xl text-(--main-color)">&lt; Retornar</Link>

                <h1 className="mb-8 text-6xl text-(--main-color) text-center">Título do artigo</h1>

                <div className="sm:w-3/4 mx-auto">
                    <h2 className="text-lg serif text-(--secondary-color)">Tema do Artigo</h2>
                    <p className="mb-4 text-zinc-400">quinta-feira, 15 de janeiro de 2026</p>
